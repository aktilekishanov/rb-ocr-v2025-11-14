...
Coordinates per-run directory layout, staged processing (acquire, OCR,
LLM doc-type check, extraction, merge, validation), error handling,
timing, and artifact/manifest writing. Public entrypoint: ``run_pipeline``.
"""
