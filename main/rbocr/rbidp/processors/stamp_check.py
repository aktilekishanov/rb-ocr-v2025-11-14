...
def _run_detector(
    image_path: str, vis_dest_dir: Optional[str] = None, vis_basename: Optional[str] = None
) -> Optional[bool]:
...
def stamp_present_for_source(
    source_path: str, vis_dest_dir: Optional[str] = None
) -> Optional[bool]:
